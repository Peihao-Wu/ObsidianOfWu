...
# ==今夕是何年==
- **🏙️==生活记录==**
	- [今日笔记](obsidian://advanced-uri?vault=NOTEs&daily=true)
	- [每周笔记](obsidian://advanced-uri?vault=NOTEs&commandid=calendar%253Aopen-weekly-note)
- **📕==知识体系==**
	- [[00. 图书馆|图书馆]]
	- [[WPH|个人主页]]
	- [[00. 文件管理|文件管理]]
...
dv.table(["日期","总结"], dv.pages('"00 - 每日日记/DailyNote"')
	.filter(isWithinWeek)
